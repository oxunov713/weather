  ...
  Future<String> request(
    ...
    try {
      Response<String> response = await switch (method) {
        Method.get => dio.get<String>(path, queryParameters: queryParameters, data: body),
        Method.post => dio.post<String>(path, queryParameters: queryParameters, data: body),
        Method.put => dio.put<String>(path, queryParameters: queryParameters, data: body),
        Method.patch => dio.patch<String>(path, queryParameters: queryParameters, data: body),
        Method.delete => dio.delete<String>(path, queryParameters: queryParameters, data: body),
      };
